...
function loadAllData() {
        products = JSON.parse(localStorage.getItem('nova_v7_products')) || [
            { id: 1, name: 'Pork Adobo', category: 'Dish', serving: '1 Plate', price: 75, stock: 20 },
            { id: 2, name: 'Chicken Inasal', category: 'Dish', serving: '1 Qtr', price: 120, stock: 15 },
            { id: 3, name: 'Iced Tea', category: 'Drinks', serving: '1 Glass', price: 25, stock: 50 }

    ];
    debts = JSON.parse(localStorage.getItem('nova_v7_debts')) || [];
    sales = JSON.parse(localStorage.getItem('nova_v7_sales')) || [];
    renderPosProducts();
    updateCartUI();
}

function saveAllData() {
    localStorage.setItem('nova_v7_products', JSON.stringify(products));
    localStorage.setItem('nova_v7_debts', JSON.stringify(debts));
    localStorage.setItem('nova_v7_sales', JSON.stringify(sales));
}
